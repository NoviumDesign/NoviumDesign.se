...
<!--[if gt IE 8]><!--> <html lang="sv"> <!--<![endif]-->
	<head>
		...
		<meta property="og:description" content="Novium är en designbyrå. Med teknik och estetik hjälper vi varumärken synas i mängden och bli valda.">
		<meta property="og:url" content="http://noviumdesign.se">
		<meta property="og:image" content="http://noviumdesign.se/img/logo.png">
			...
			<div class="portfolio">
				...
				<div class="row">
					<div class="span12 lundberg">
						<a href="http://idalundberg.com"><img src="img/frontgrid/idalundberg.jpg" alt="Ida Lundberg"></a>
					</div>
				</div>
			</div>
		</div>	
